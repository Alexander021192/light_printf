...
/*   Updated: 2021/03/17 13:11:51 by alexandr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(int argc, char **argv)
{
	...
	all.win.win = mlx_new_window(all.win.ptr, all.win_width, all.win_height,
	"Hello world, i am cub3D!");
